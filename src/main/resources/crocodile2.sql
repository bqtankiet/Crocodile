...
-- ----------------------------
INSERT INTO `carousels` VALUES (1, 'Đẳng cấp và sang trọng', 'Túi xách da cá sấu cao cấp, điểm nhấn hoàn hảo cho phong cách của bạn. Khám phá bộ sưu tập mới nhất tại cửa hàng của chúng tôi!', 'http://localhost:8080/crocodile/uploads/images/carousels/carousel1.png', 'http://localhost:8080/crocodile/uploads/images/carousels/carousel1.png', 1);
INSERT INTO `carousels` VALUES (2, 'Thời thượng và quý phái ', 'Túi xách da cá sấu cao cấp, điểm nhấn hoàn hảo cho phong cách của bạn. Khám phá bộ sưu tập mới nhất tại cửa hàng của chúng tôi!', 'http://localhost:8080/crocodile/uploads/images/carousels/carousel2.png', 'http://localhost:8080/crocodile/uploads/images/carousels/carousel2.png', 1);
INSERT INTO `carousels` VALUES (3, 'Cao cấp và chất lượng', 'Túi xách da cá sấu cao cấp, điểm nhấn hoàn hảo cho phong cách của bạn. Khám phá bộ sưu tập mới nhất tại cửa hàng của chúng tôi!', 'http://localhost:8080/crocodile/uploads/images/carousels/carousel3.png', 'http://localhost:8080/crocodile/uploads/images/carousels/carousel3.png', 1);
...
-- ----------------------------
INSERT INTO `categories` VALUES (1, 'Ví Nam', 'http://localhost:8080/crocodile/uploads/images/categories/cate-1.png', 1);
INSERT INTO `categories` VALUES (2, 'Ví Nữ', 'http://localhost:8080/crocodile/uploads/images/categories/cate-2.png', 1);
INSERT INTO `categories` VALUES (3, 'Túi Xách Nam', 'http://localhost:8080/crocodile/uploads/images/categories/cate-3.png', 1);
INSERT INTO `categories` VALUES (4, 'Túi Xách Nữ', 'http://localhost:8080/crocodile/uploads/images/categories/cate-4.png', 1);
INSERT INTO `categories` VALUES (5, 'Túi Đeo Chéo', 'http://localhost:8080/crocodile/uploads/images/categories/cate-5.png', 1);
INSERT INTO `categories` VALUES (6, 'Balo', 'http://localhost:8080/crocodile/uploads/images/categories/cate-6.png', 1);
INSERT INTO `categories` VALUES (7, 'Vali', 'http://localhost:8080/crocodile/uploads/images/categories/cate-7.png', 1);
INSERT INTO `categories` VALUES (8, 'Thắt Lưng', 'http://localhost:8080/crocodile/uploads/images/categories/cate-8.png', 1);
INSERT INTO `categories` VALUES (9, 'Áo Khoác', 'http://localhost:8080/crocodile/uploads/images/categories/cate-9.png', 1);
INSERT INTO `categories` VALUES (10, 'Giày Tây', 'http://localhost:8080/crocodile/uploads/images/categories/cate-10.png', 1);
INSERT INTO `categories` VALUES (11, 'Giày Cao Gót', 'http://localhost:8080/crocodile/uploads/images/categories/cate-11.png', 1);
INSERT INTO `categories` VALUES (12, 'Dép', 'http://localhost:8080/crocodile/uploads/images/categories/cate-12.png', 1);
INSERT INTO `categories` VALUES (13, 'Phụ Kiện', 'http://localhost:8080/crocodile/uploads/images/categories/cate-13.png', 1);
INSERT INTO `categories` VALUES (14, 'Danh Mục Khác', 'http://localhost:8080/crocodile/uploads/images/categories/cate-14.png', 1);
