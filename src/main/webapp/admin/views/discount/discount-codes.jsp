...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container">
        ...
        <jsp:include page="/admin/views/includes/sidebar.jsp">
            <jsp:param name="activePage" value="discount"/>
        </jsp:include>
        <!-- / Sidebar -->
        <div class="layout-page">
            ...
            <jsp:include page="/admin/views/includes/header-breadcrumb.jsp">
                <jsp:param name="breadcrumbs" value="Quản lý mã giảm giá"/>
            </jsp:include>
            <!-- / Header -->

            <!-- Content -->
            <jsp:include page="/admin/views/discount/discount-codes-content.jsp"/>
            <!-- / Content -->
        </div>
