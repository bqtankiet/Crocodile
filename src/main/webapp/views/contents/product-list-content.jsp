                ...
                <div class="ms-1 ms-lg-0 bg-secondary-subtle p-3">
                    ...
                    <div class="collapse" id="collapseCategory">
                        ...
                        <ul class="category-list row list-unstyled mb-2 ms-3 gy-2">
                            <li class="category-item col-4 active"><a href="#" class="text-decoration-none">Ví nam</a></li>
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Ví nữ</a></li>
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Túi xách nam</a></li>
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Túi xách nữ</a></li>
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Túi đeo chéo</a></li>
                            ...
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Thắt lưng</a></li>
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Áo khoác</a></li>
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Giày tây</a></li>
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Giày cao gót</a></li>
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Phụ kiện</a></li>
                            <li class="category-item col-4"><a href="#" class="text-decoration-none">Danh mục khác</a></li>
                        </ul>
                    </div>
                </div>
                <!-- Muc gia -->
