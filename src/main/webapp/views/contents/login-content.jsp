...
<div id="page">
    ...
    <div class="container-fluid d-flex flex-wrap justify-content-center align-items-center gap-4 py-5">
        ...
        <div class="card shadow p-4" style="width: 28rem">
            ...
            <!-- Sửa form -->
            <form id="loginForm" action="${pageContext.request.contextPath}/login" method="post" class="d-grid gap-4">
            ...
            <div class="d-flex gap-3 justify-content-between mt-3">
                ...
                <a href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8080/crocodile/&response_type=code&client_id=841108618342-pc5358jl3u8dnsaru2hitfjers87naaj.apps.googleusercontent.com&approval_prompt=force"
                   target="_blank"
                   class="d-flex flex-grow-1 align-items-center justify-content-center text-decoration-none border p-2">
                    <div class="custom-icon" style="--size: 2rem">
                        <!-- Icon Google -->
            ...
            <div>
                <p class="text-center">Bạn Chưa Có Tài Khoản? <a href="signup.html" class="custom-text-primary">Đăng
                    Ký</a> Ngay</p>
            </div>
        </div>
