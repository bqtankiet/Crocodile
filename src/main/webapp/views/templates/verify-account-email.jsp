    ...
    <tr>
        <td style="padding: 20px;">
            ...
            <p style="margin-top: 20px; text-align: center;">
                <a href="${requestScope.verificationURL}" style="background-color: #007b5f; color: #ffffff; padding: 10px 20px; text-decoration: none; border-radius: 5px; font-size: 16px;">Xác thực tài khoản</a>
            </p>
        </td>
    </tr>
    <!-- Footer -->
