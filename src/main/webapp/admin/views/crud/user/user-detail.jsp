...
<head>
    ...
    <link rel="stylesheet" href="<c:url value="/admin/assets/css/user-detail.css"/>">
    ...
    <div class="layout-container">
        ...
        <div class="layout-page">
            ...
            <jsp:include page="/admin/views/includes/header-breadcrumb.jsp">
                <jsp:param name="breadcrumbs" value="Quản lý người dùng|/admin/user"/>
                <jsp:param name="breadcrumbs" value="Chi tiết người dùng"/>
            </jsp:include>
            <!-- / Header -->

            <!-- Content -->
            <jsp:include page="/admin/views/contents/user/user-detail-content.jsp"/>
            <!-- / Content -->
        </div>
    </div>
</div>
