    ...
    <div class="container-fluid d-flex flex-wrap justify-content-center align-items-center gap-5 "
        ...
        <form action="<c:url value="/signup"/>" method="post">
            <div class="d-flex card shadow p-4" style="width: 28rem">
                ...
                <form id="userInforform" class="d-grid gap-3">
                    <div class="d-flex gap-4">
                        <input class="form-control p-1" type="text" id="name" placeholder="Họ " required>
                        <input class="form-control p-1" type="text" id="lastname" placeholder="Tên" required>
                    </div>
                    <label for="userInforform">Ngày Sinh</label>
                ...
                <form id="genderform" class="d-grid gap-2 mb-3">
                    <label for="genderform">Giới Tính:</label>
                ...
                <form id="userform" class="d-grid gap-2 mb-1">
                    <input class="form-control p-2 pb-2" type="text" id="username" placeholder="Tên Đăng Nhập" required>
                    <input class="form-control p-2 mt-2" type="text" id="email"
