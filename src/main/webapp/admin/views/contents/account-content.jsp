                            ...
                            <div class="row">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="fullname"
                                           name="fullname" value="${sessionScope.fullName}" placeholder="Tên"/>
                                </div>

                                <div class="mb-3 col-md-6">
                                    <label for="email" class="form-label">E-mail</label>
                                    <input class="form-control" type="text" id="email" name="email"
                                           value="${sessionScope.email}" placeholder="abc@example.com"/>
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" id="gender"
                                           name="gender" value="${sessionScope.gender}"/>
                                </div>
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="role"
                                           id="role" value="Admin" placeholder="Vai trò"/>
                                </div>
